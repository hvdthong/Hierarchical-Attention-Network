    ...
    for i in range(1, num_epoch + 1):
        ...
        for j in range(int(train_length / batch_size)):
            ...
            if code_test and j % int(print_loss_every / batch_size) == 0:
                print('Loss at %d paragraphs, %d epoch,(%s) is %f' % (j * batch_size, i, timeSince(start),
                                                                      np.mean(loss_epoch)))
                print('Accuracy at %d paragraphs, %d epoch,(%s) is %f' % (j * batch_size, i, timeSince(start),
                                                                          np.mean(acc_epoch)))
...
if __name__ == '__main__':
    ...
    # print(max_seq_len, max_sent_len)  # max sequence of our data, max length of our data
    ...
    print('Final accuracy after training:', test_accuracy(batch_size, X_test_pad, y_test_tensor, sent_attn))
